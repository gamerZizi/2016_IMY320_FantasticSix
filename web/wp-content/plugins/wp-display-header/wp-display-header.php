...
class Obenland_Wp_Display_Header extends Obenland_Wp_Plugins_v301 {
	...
	public function admin_print_styles( $screen ) {
		if ( in_array( $screen, array( 'post-new.php', 'post.php', 'term.php', 'edit-tags.php', 'profile.php', 'user-edit.php' ) ) ) {
	...
	public function settings_section_callback() {
		...
		} elseif ( in_array( get_current_screen()->base, array( 'edit-tags', 'term' ) ) ) {
